...
public:
    ...
    boost::shared_ptr<camera_info_manager::CameraInfoManager> cam_cinfo_;
...
private:
    ...
    map<int64_t, geometry_msgs::PointStamped>    pose_data_;
    map<int64_t, sensor_msgs::Imu>         imu_data_;

    DataThread<int64_t> data_stamp_thread_;
    DataThread<int64_t> pose_thread_;
    DataThread<int64_t> imu_thread_;
    DataThread<int64_t> livox_thread_;
    DataThread<int64_t> cam_thread_;
    ...
    vector<string> livox_file_list_;
    vector<string> cam_file_list_;
    ...
    pair<string,livox_ros_driver::CustomMsg> livox_next_;
    pair<string,cv::Mat> cam_next_;
